 ...
 *   折り上げた先がちょうど❼の折り線に重なる)、**あご側は y=-0.647(❼と同じ線)**。
 *   2026-08-09 修正: あご側を y=-0.804 にしていたためマズルの下に地の色の帯が残り、
 *   完成形が 1.32:1 の縦長になっていた(折り図の完成図と❽の図はどちらも 1.56:1、
 *   マズルの白が一番下まで届く)。前後の層の先を同じ線で互い違いに折るのが正しい
 *
