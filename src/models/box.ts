 ...
 *
 * 2026-08-13 原典照合メモ:
 * おりがみくらぶ traditional/box の「はこ1」は、対角線の折りすじ→四すみを中心へ→
 * 左右/上下を中心へ→左右を開いて立体化、という7パネルの別手順だった。
 * このファイルの3工程トレイは完成用途は近いが、工程順・折る層・折り線が原典と
 * 一致しない。docs/model-verification-report.md では段階Aの相違として記録済み。
 * 原典準拠にする場合は、4x4格子+対角線の展開図から作り直すこと。
 *
 *   ❶ 上下のふちを立てる(同時) → 手前と奥の壁
