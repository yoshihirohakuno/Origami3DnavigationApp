 ...
 * - **❷ は y=±2/3**。折り図❷の破線(±0.37)は**折ったふちの着地線**であって折り線ではない
 *   (破線どおりに折ると帯が中央で重なり、折り図❸の「白い中央」が出ない)。
 *   y=±2/3 で折ると **帯 1/3・白い中央 2/3・全高 4/3** の3つが同時に合う
 *   (折り図❸の実測: 帯 0.31 / 全高 1.31 / 中央 0.69)
 ...
 * ❺で一面が色になる)。辺の長さのずれ 0.000。完成形の横縦比 2.49。
 * **折り図❼の完成図の比 2.32 とは 7% ずれる**が、これは折り図がピークを
 * 実際より高く描いている(実測 0.917 に対し、折りから決まる厳密値は 0.867)ため。
 * 車輪の底の平らな幅は 0.119(折り図❺❻の実測 0.118/0.119)で一致する。
 *
